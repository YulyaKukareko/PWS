<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControl1.ascx.cs" Inherits="Lab_3_6.WebUserControl1" %>
...
<div style="display: flex; flex-direction: column; max-width: 200px; margin-bottom: 20px;">
    ...
    <asp:Button ID="input" UseSubmitBehavior="false" ValidationGroup="v1" runat="server" />
